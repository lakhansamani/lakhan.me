<div class="flex justify-center lg:justify-between align-middle flex-wrap-reverse lg:flex-no-wrap">
	<div class="flex-initial lg:pr-10 lg:w-2/3">
		<div class="my-5">
			<div class="text-center lg:text-left italic text-4xl font-bold  text-yellow-500">Hello World 👋</div>
			<div class="text-center lg:text-left italic text-3xl font-bold text-yellow-300 ">I'm Lakhan Samani</div>
		</div>
	...
	<div class="flex-initial">
		<img src="images/profile.jpg" alt="profile" class="rounded-full lg:rounded-md h-64 my-5"/>
	</div>
</div>
